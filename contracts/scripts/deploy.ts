...
async function main() {
    ...
    const DigitalObjectNFT = await ethers.getContractFactory("DigitalObjectNFT");
    ...
    const ProvenanceRegistryV2 = await ethers.getContractFactory("ProvenanceRegistryV2");
